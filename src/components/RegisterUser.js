...
class RegisterUser extends React.Component {
  ...
  registerUserHandler = (event) => {
    ...
    if (onlyAlphabets.test(this.state.firstname)) {
      errors.firstname =
  ...
  registerUser = async (user) => {
    delete user.errors;
    console.log("user in registerUserHandler", user);
    let response = null;
    // try {
  ...
  render() {
    ...
    if(errorFromServer){
      return (
        <>
          <div className="container">
            <div className="title">Something Wrong with the server. Please try again later!</div>
      ...
      return (
        <>
          <div className="container">
          <div className="title">Thank you for the Registration</div><br/>
            <p>{response.name}</p>
            <p>Gothra: {response.gothra}</p>
            <p>Nakshatra: {response.nakshatra}</p>
            <p>Address</p>
            <p>{response.street} {response.unit}</p>
            <p>{response.city} {response.state} {response.zip}</p>
            <p>Subscriptions</p>
            <p>Weekly Email: {response.weekly_email} Whatsapp: {response.whatsapp} MahaRudra: {response.maha_rudra}</p>
            <br/>
